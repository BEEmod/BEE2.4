...
class Trie(MutableMapping[KeyT, ValueT], Generic[KeyT, ValueT]):
    ...
    @overload
    def update(self, m: Mapping[KeyT, ValueT], /, **kwargs: ValueT) -> None: ...
    @overload
    def update(self, m: Iterable[tuple[KeyT, ValueT]], /, **kwargs: ValueT) -> None: ...
    @overload
    def update(self, /, **kwargs: ValueT) -> None: ...
