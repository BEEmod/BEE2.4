...
from precomp import instanceLocs, options, collisions, conditions, rand
...
def res_add_shuffle_group(vmf: VMF, coll: collisions.Collisions, res: Property) -> Callable[[Entity], None]:
